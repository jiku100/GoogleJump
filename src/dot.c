...
static unsigned short dot_decimal[10][MAX_DOT] = {
	{0x02, 0x14, 0x78, 0x15, 0x02},	// running 1
	{0x04, 0x14, 0x78, 0x14, 0x03},	// running 2
	{0x00, 0x00, 0x00, 0x00, 0x00},	// offset
	{0x00, 0x00, 0x00, 0x00, 0x00},	// offset
	{0x22, 0x14, 0x04, 0x14, 0x22},	// crash
	{0x08, 0x29, 0x73, 0x29, 0x04},	// jumping
	{0x00, 0x00, 0x00, 0x00, 0x00},	// offset
	{0x00, 0x00, 0x00, 0x00, 0x00},	// offset
	{0x00, 0x00, 0x00, 0x00, 0x00},	// offset
	{0x01, 0x4A, 0x6C, 0x4B, 0x10},	// sliding	
};
